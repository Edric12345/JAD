                ...
                <div class="card-body">
                    ...
                    <c:choose>
                        <c:when test="${not empty sessionScope.customer_id}">
                            ...
                            <a href="<%= request.getContextPath() %>/customer/book-service/${s.id}" class="btn btn-primary btn-sm mt-2">
                                Book Appointment
                            </a>
                        </c:when>
                        <c:otherwise>
                            <%-- Guest view --%>
                            <a href="<%= request.getContextPath() %>/customer/login" class="btn btn-outline-secondary btn-sm mt-2">
                                Login to Book
                            </a>
                        </c:otherwise>
                    </c:choose>
